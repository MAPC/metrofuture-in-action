...
listen '/tmp/staging.metrofuture-in-action.socket', backlog: 64
listen 8011
...
if env == 'production'
  ...
  working_directory '/home/deployer/apps/staging.metrofuture.org/current'

  # feel free to point this anywhere accessible on the filesystem
  user 'deployer', 'staff'
  shared_path = '/home/deployer/apps/staging.metrofuture.org/shared'
